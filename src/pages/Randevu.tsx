    ...
    <Layout>
      <div className="min-h-[80vh] py-12">
        <div className="container mx-auto px-4">
          ...
          {!user && (
            <div className="max-w-lg mx-auto mb-8 bg-destructive/10 border border-destructive/20 rounded-lg p-4 text-center">
              <h3 className="font-semibold text-destructive mb-2">Giriş Yapmalısınız</h3>
              <p className="text-sm text-destructive/80 mb-4">
                Randevu oluşturabilmek için lütfen giriş yapın veya kayıt olun.
              </p>
              <Button onClick={() => navigate("/giris")} variant="destructive" size="sm">
                Giriş Yap
              </Button>
            </div>
          )}

          {/* Progress Steps (Hidden if not logged in) */}
          {user && (
          ...
          <div className="max-w-lg mx-auto">
            {/* Show Steps only if User is Authenticated */}
            {user ? (
              <>
